...
{
	function saverecords($name,$email,$userid,$date,$time,$appointmentfor,$phone)
	{
	$query="insert into appointments values('','$name','$email','$userid','$date','$time','$appointmentfor','requested','$phone')";
	$this->db->query($query);
