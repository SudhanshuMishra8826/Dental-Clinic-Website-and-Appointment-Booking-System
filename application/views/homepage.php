  ...
  <div class="row text-center  " style="padding:15px;">
    <div class="col-lg-4 col-md-4 col-sm-4 col-4 d-block m-auto">
      <div class="d-block m-auto">
       ...
       <h3 class="text-white"><span style="font-style: italic; color: red;">Acme</span> Dental Care</h3> 
    ...
    <div class="col-lg-6 col-md-6 col-sm-6 col-6 d-block m-auto">
      <div class="d-block m-auto">
       <h4 class="text-white">Experience the Advancement of Dentisty</h4>
      </div>
    </div>
  </div>
</div>
...
<div id="carouselExampleIndicators" class="carousel slide carousel-fade" data-ride="carousel"  data-interval="2000"  style="margin-top: -56px; ">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active"  >
      ...
      <img class="d-block w-100" src="<?php echo base_url();?>/dc1_images/9.jpg" alt="First slide">
       <div class="carousel-caption d-none d-md-block" style="margin-bottom:  290px; margin-right: 350px; margin-left: -90px;">
    ...
    <div class="carousel-item"  >
      <img class="d-block w-100" src="<?php echo base_url();?>/dc1_images/main-image.jpg" alt="Second slide" style="background-attachment: fixed;">
        <div class="carousel-caption d-none d-md-block" style="margin-bottom:  290px; margin-right: 350px; margin-left: -90px;">
    ...
    <div class="carousel-item"  >
      <img class="d-block w-100" src="<?php echo base_url();?>/dc1_images/family-dentist-header.jpg" alt="Third slide">
         <div class="carousel-caption d-none d-md-block" style="margin-bottom:  290px; margin-right: 350px; margin-left: -90px;">
...
<section class="container-fluid bg-info text-center" id="2ndsec">
...
class dentistry and let us be a part of your smile.</p>
               <a class="btn btn-dark text-center btn1" role="button" href="<?php echo base_url();?>dental1/homepage/about_us">Read More</a>
           </div>
        </div>
        <div class="col-lg-6 col-md-6 col-sm-10 col-10 d-block m-auto">
           <div class="d-block m-auto" style="padding-bottom: 25px;">                
               <div id="carouselExampleControls" class="carousel slide" data-ride="carousel" data-interval="2000" style="float: right;border-style: solid; border-width: 5; border-color:  #4db8ff; ">
                  <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img class="d-block w-100" src="<?php echo base_url();?>/dc1_images/26229999_174082143197604_5273773021954518344_n.jpg" alt="First slide">
                    </div>
                    <div class="carousel-item">
                       <img class="d-block w-100" src="<?php echo base_url();?>/dc1_images/26907872_176020513003767_1167050437066330406_n.jpg" alt="Second slide">
                    </div>
                    <div class="carousel-item">
                      <img class="d-block w-100" src="<?php echo base_url();?>/dc1_images/44232057_302082210397596_3368090968153653248_n.jpg" alt="Third slide">
                    </div>
                    </div>
    ...
    <div class="col-lg-3 col-md-3 col-sm-6 col-10 d-block m-auto text-center">
        ...
        <div class="card text-white bg-danger mb-3" style="max-width: 18rem;">
          <div class="card-header">
            ...
            <div class="card-body">
               <h5 class="card-title">Visited  for cleaning</h5>
               <p class="card-text" style="text-align: justify;">Great Job! The work was done expeditiously. I am very satisfied with the outcome</p><br><br><br><br>
            </div>
          </div>
        </div>
       

<div class="col-lg-3 col-md-3 col-sm-6 col-10 d-block m-auto">

        <div class="card text-white bg-info mb-3" style="max-width: 18rem;">
          <div class="card-header">
            <i class="fa fa-user-circle-o fa-3x"></i> 
            <h5> Sara villa huerga </h5></div>
            <div class="card-body">
               <h5 class="card-title">Visited for Artificial Teeth</h5>
               <p class="card-text" style="text-align: justify;">I have been coming all the way from Viman Nagar to this clinic for the last 2-3 years as I find their professionalism and hygiene the best of Pune. Their products are also of a high quality, not having any further problem with the caps they placed 3 years ago!</p> 
            </div>
          </div>
        </div>
...
<div class="col-lg-3 col-md-3 col-sm-6 col-10 d-block m-auto">
        ...
        <div class="card text-white bg-warning mb-3" style="max-width: 18rem;">
          <div class="card-header">
          <i class="fa fa-user-circle-o fa-3x"></i> 
        <h5>Kang young</h5></div>
            <div class="card-body">
               <h5 class="card-title">Visited for Dental Cleaning</h5>
               <p class="card-text" style="text-align: justify;">Trained staff to help, good and latest instruments and his explanation to different dental deceases was impressive</p><br><br><br>
            </div>
          </div>
        </div>
        ...
        <div class="card text-white bg-Success mb-3" style="max-width: 18rem;">
          <div class="card-header"><i class="fa fa-user-circle-o fa-3x"></i> 
            <h5>Ashish Thakur</h5></div>
            <div class="card-body">
               <h5 class="card-title">Visited for Dental Abrasion</h5>
               <p class="card-text" style="text-align: justify;">He is very patient and professional. Gives dedicated time to listen to problems . Never has he insisted on additional treatments. My complete family visit him.</p><br>
            </div>
          </div>
        </div>
