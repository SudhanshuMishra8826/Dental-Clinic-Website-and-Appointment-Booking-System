    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
     ...
     <style type="text/css">
       p{
        ...
        .img-jumbo{
          background:linear-gradient(rgba(0,0,0,0.5),rgba(0,0,0,0.5)),url('http://localhost/ci2/dc1_images/banner-3-1400x518.jpg'); 
...
<nav class="navbar fixed-top navbar-expand-lg navbar-light bg-dark"> 
  ...
  <div class="collapse navbar-collapse" id="navbarNavDropdown">
    <ul class="navbar-nav navbar-nav ml-auto" style="margin-right: 20px;">
     ...
     <li class="nav-item ">
        <a class="nav-link active" href="<?php echo base_url();?>dental1/homepage/services_oral_hygiene">SERVICES<span class="sr-only">(current)</span></a>
      </li>
...
<!navbar end> 
 ...
 <!----------section style="background:url('http://localhost/ci2/dc1_images/Untitled.png') no-repeat; width: 100%; height: 60vh;  opacity: 1.0; background-attachment: fixed; margin-top: - 0px;">
   <!h1 class="text-dark"style="margin-top:  50px; padding:150px 1000px   0px; background-attachment: fixed;"> </h1>
...
<!service start>
<section class="container-fluid bg-info text-center" style="margin-top:-35px;">
...
If your gums appear red and swollen or bleed often, you may have gingivitis ( inflammation of the gums ). This condition is usually reversible and can be corrected by dental cleaning and good oral hygiene routine. The more severe form of gum inflammation is called Periodontitis ( inflammation of the gums and surrounding tissues of the teeth like bone and periodontal tissues ).The disease then progresses to the bone level and teeth start getting lose. This form of the disease is not reversible and will need surgical intervention.<br> 
</p>
 <div class="col-lg-6 col-md-6 col-sm-10 col-12 d-block m-auto" style="float: right;">
           <div class="d-block m-auto" style="padding-bottom: 25px;">                
                <div class="embed-responsive embed-responsive-16by9" style="float: right;border-style: solid; border-width: 5; border-color:  #4db8ff; ">
                       <iframe width="560" height="315" src="https://www.youtube.com/embed/nGcrdhLv2v8" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </div>
              </div>
           </div>
...
Grossly decayed tooth<br> 
Fractured tooth<br> 

Abscessed baby tooth<br> 

Failed root canal treatment<br> 
...
<section id="clinic" class="container-fluid bg-white" style="margin-top: 50px;">
    ...
    <div class="col-lg-10 col-md-10 col-sm-10 col-12 d-block m-auto" style="padding:  0px;">
           ...
           <div class="d-block m-auto" style="padding-bottom: 25px;">                
                <div class="embed-responsive embed-responsive-16by9"  style="float: right;border-style: solid; border-width: 5; border-color:  #4db8ff; " >
                      <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/n430zHShK0U" allowfullscreen></iframe>
                </div>
           </div>
        </div>
